...
<%@page import="org.apache.taglibs.standard.tag.el.core.RedirectTag"%>
	...
	function myFunction() {
	 setInterval(function(){ 
			<sql:query dataSource="${db}" var="rs">  
			 SELECT COUNT(task) AS remainder FROM task WHERE userid= 1 AND status=0;
								</sql:query>}, 3000);  
									...
									<div class="trd-history-tabs">
										<ul class="nav" role="tablist">
											<li><a class="active" data-toggle="tab"
												href="#buy_order" role="tab">Buy Order</a></li>
							...
							<div class="card-body">
								...
								<div class="letest-news mt-5">
									<div class="single-post mb-xs-40 mb-sm-40">
										<div class="lts-thumb">
											<img src="assets/images/blog/post-thumb1.jpg"
												alt="post thumb">
										</div>
									...
									<div class="single-post">
										<div class="lts-thumb">
											<img src="assets/images/blog/post-thumb2.jpg"
												alt="post thumb">
										</div>
										<div class="lts-content">
											<span>Admin Post</span>
