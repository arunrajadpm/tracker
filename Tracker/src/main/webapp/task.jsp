                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-layout-sidebar-left"></i><span>Tasks
                                    ...
                                    <div class="table-responsive">
                                        <table class="table text-center">
                                            ...
                                            <c:forEach var="tl" items="${tasklist}">
                                                <tr>
                                                    <th scope="row"><c:out value=" ${tl.id}" /></th>
                                                    <td><c:out value=" ${tl.taskdetails}" /></td> 
                                                    <td><a href=""><font color="#102cef">Accept</font></a></td>
								                    <td><a href=""><font color="#f01b0c">Decline</font></a></td>
                                                </tr>
                                               </c:forEach>
                                            </tbody>
                                        </table>
